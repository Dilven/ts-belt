...
```ts
function concat(str: string, append: string): string
function concat(append: string): (str: string) => string
```
...
```ts
function match(str: string, regex: RegExp): Option<ReadonlyArray<string>>
function match(regex: RegExp): (str: string) => Option<ReadonlyArray<string>>
```
...
function splitAt(index: number): (str: string) => [string, string]
```
...
```ts
function splitByRe(str: string, regex: RegExp): ReadonlyArray<Option<string>>
function splitByRe(regex: RegExp): (str: string) => ReadonlyArray<Option<string>>
```
...
```ts
function toArray(str: string): ReadonlyArray<string>
```
